...
public class User implements Serializable {
    ...
    // VIP fields
    private java.math.BigDecimal cumulativeSpending; // 累计消费
    private Integer vipLevel; // 0-普通,1-黄金,2-钻石

    // Constructors
    public User() {
        this.cumulativeSpending = java.math.BigDecimal.ZERO;
        this.vipLevel = 0;
    }
    ...
    // VIP getters/setters
    public java.math.BigDecimal getCumulativeSpending() { return cumulativeSpending; }
    public void setCumulativeSpending(java.math.BigDecimal cumulativeSpending) { this.cumulativeSpending = cumulativeSpending; }
