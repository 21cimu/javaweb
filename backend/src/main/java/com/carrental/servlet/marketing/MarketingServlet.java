...
public class MarketingServlet extends HttpServlet {
    ...
    private void handlePromotions(HttpServletRequest request, HttpServletResponse response)
        ...
        promo1.put("image", "/images/promo/new-user.jpg");
        ...
        promo2.put("image", "/images/promo/weekend.jpg");
        ...
        promo3.put("image", "/images/promo/long-term.jpg");
        ...
        promo4.put("image", "/images/promo/second-order.jpg");
    ...
    private void handleClaimCoupon(HttpServletRequest request, HttpServletResponse response,
        ...
        if (coupon.getPerUserLimit() != null && userCount >= coupon.getPerUserLimit()) {
            JsonUtil.writeError(response, 400, "已达到领取上限");
            return;
        }
    ...
    private List<Map<String, Object>> getUserCoupons(Long userId, Integer status) {
        ...
        String sql = """
            SELECT uc.*, c.code, c.name, c.description, c.type, c.min_amount,
