...
// Resolve vehicle image URL: prefer mainImage, then images[0], else placeholder
const getImageUrl = (vehicle) => {
  if (!vehicle) return '/images/car-placeholder.jpg'
...
const handleSearch = () => {
  ...
  if (searchForm.value.pickupTime) query.pickupTime = searchForm.value.pickupTime
  if (searchForm.value.returnTime) query.returnTime = searchForm.value.returnTime
